...
struct AppBundleBrandingTests {
    @Test func iOSBundleUsesRemForBothUserVisibleNames() throws {
        ...
        let data = try Data(contentsOf: root.appendingPathComponent("Rem/Info.plist"))
    ...
    @Test func debugAndReleaseKeepInternalArtifactsAndUseRemPermissionCopy() throws {
        let project = try String(
            contentsOf: projectRoot().appendingPathComponent("Rem.xcodeproj/project.pbxproj"),
            encoding: .utf8
        )
        ...
        for configurationID in ["7778127B2F374DFC0003116E", "7778127C2F374DFC0003116E"] {
            ...
            #expect(configuration.contains("INFOPLIST_FILE = Rem/Info.plist;"))
            ...
            #expect(!configuration.contains("Rem needs"))
        }
    }
