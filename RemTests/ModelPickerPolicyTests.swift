...
struct ModelPickerPolicyTests {
    ...
    @Test func explicitSelectionSuppliesAuthProbeWhenModelsListIsEmpty() {
        ...
        #expect(ModelPickerPolicy.providerIDsForRuntimeEvidence(
            models: [],
            requestedSelectionID: RemChatViewModel.defaultModelSelectionID).isEmpty)
    }
    ...
    @Test func verifiedExplicitProviderSurvivesIncompleteCatalogThroughSendSelectionPolicy() {
        ...
        #expect(unavailableSelection == RemChatViewModel.defaultModelSelectionID)
        #expect(authoritativeCatalogMiss == RemChatViewModel.defaultModelSelectionID)
    ...
    private let miniMax = RemChatModelChoice(
        modelID: "MiniMaxAI/MiniMax-M2.7",
        name: "MiniMax M2.7",
        provider: "gmi",
        contextWindow: 196_608)
    private let staleSonnet = RemChatModelChoice(
        modelID: "claude-sonnet-4-5",
        name: "Claude Sonnet 4.5",
        provider: "anthropic",
        contextWindow: 200_000)
    private let directMiniMax = RemChatModelChoice(
    ...
    @Test func composerTitleReflectsAutomaticAndExplicitSelection() {
        #expect(ModelPickerPresentation.composerTitle(
            selectionID: RemChatViewModel.defaultModelSelectionID,
    ...
    @Test func composerGroupsOnlyUsableProvidersAndSortsModels() {
        let olderSonnet = RemChatModelChoice(
    ...
    @Test func composerDoesNotExposeManagedProviderSiblingModels() {
        let managedSibling = RemChatModelChoice(
    ...
    @Test func providerQualifiedDefaultWinsWhenModelIDsOverlap() {
        let direct = RemChatModelChoice(
            modelID: "shared-model",
            name: "Direct Shared",
            provider: "anthropic",
            contextWindow: 32_000)
        let routed = RemChatModelChoice(
            modelID: "shared-model",
