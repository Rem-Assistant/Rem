...
// This target is the iOS test target, so it cannot link or execute `RemMac` view code; reading
...
//
// Reachability and routing state ARE covered behaviourally, in `RemMacTests`
...
struct MainWindowScreenRouteTests {
    ...
    @Test func macShellUsesSingleSidebarAffordance() throws {
        ...
        let mainWindow = try read("RemMac/Sources/UI/MainWindow.swift", from: projectRoot)
        ...
        let macApp = try read("RemMac/Sources/App/RemMacApp.swift", from: projectRoot)
        #expect(macApp.contains("SidebarCommands()"))

        let readme = try read("RemMac/Sources/UI/README.md", from: projectRoot)
    ...
    @Test func macChatUsesNativeNavigationHostAndFallbackTitle() throws {
        ...
        let chatWindow = try read("RemMac/Sources/UI/MacChatWindow.swift", from: projectRoot)
    ...
    @Test func iOSVoiceChatWiresMuteAndKeepsStreamingQuestionBeforeLiveReply() throws {
        ...
        let remChatView = try read("Rem/Sources/Chat/RemChatView.swift", from: projectRoot)
    ...
    @Test func macChatTransportHasBoundedMemoryDiagnostics() throws {
        ...
        let transport = try read("RemMac/Sources/Gateway/MacChatTransport.swift", from: projectRoot)
        ...
        #expect(!transport.contains("private static func historyMetrics(payload: RemChatHistoryPayload)"))

        let readme = try read("RemMac/Sources/Gateway/README.md", from: projectRoot)
    ...
    @Test func macSettingsChildRoutesOwnNativeNavigationTitles() throws {
        ...
        let permissionsTab = try read("RemMac/Sources/UI/PermissionsTab.swift", from: projectRoot)
        ...
        let macFullSettings = try read("RemMac/Sources/UI/MacFullSettingsView.swift", from: projectRoot)
    ...
    @Test func macPermissionsFixtureAndDocsExplainDeviceVsConnectorScope() throws {
        ...
        let permissionManager = try read("RemMac/Sources/Permissions/MacPermissionManager.swift", from: projectRoot)
        ...
        let project = try read("Rem.xcodeproj/project.pbxproj", from: projectRoot)
        ...
        let macEntitlements = try read("RemMac.entitlements", from: projectRoot)
        #expect(macEntitlements.contains("com.apple.security.device.audio-input"))

        let permissionsReadme = try read("RemMac/Sources/Permissions/README.md", from: projectRoot)
    ...
    @Test func macTaskCreateSheetUsesNativeNavigationChrome() throws {
        ...
        let taskCreateView = try read("RemMac/Sources/UI/MacTaskCreateView.swift", from: projectRoot)
    ...
    @Test func macTaskDetailUsesNativeRouteChrome() throws {
        ...
        let taskDetail = try read("RemMac/Sources/UI/MacTaskDetailView.swift", from: projectRoot)
