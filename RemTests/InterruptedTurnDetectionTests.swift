...
struct InterruptedTurnDetectionTests {
    ...
    private func text(_ s: String, type: String = "text") -> RemChatMessageContent {
        RemChatMessageContent(type: type, text: s, mimeType: nil, fileName: nil, content: nil)
    }

    private func thinking(_ s: String) -> RemChatMessageContent {
        RemChatMessageContent(
            type: "thinking", text: nil, thinking: s, mimeType: nil, fileName: nil, content: nil)
    }

    private func toolCall(name: String) -> RemChatMessageContent {
        RemChatMessageContent(
    ...
    private func attachment(type: String = "file") -> RemChatMessageContent {
        RemChatMessageContent(
    ...
    private func message(
        role: String,
        _ content: [RemChatMessageContent],
