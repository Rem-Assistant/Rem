...
struct BrowserCardStateResolverTests {
    ...
    private func userMessage(_ text: String) -> RemChatMessage {
        RemChatMessage(
            role: "user",
            content: [RemChatMessageContent(type: "text", text: text, mimeType: nil, fileName: nil, content: nil)],
            timestamp: nil)
    }

    private func assistantText(_ text: String) -> RemChatMessage {
        RemChatMessage(
            role: "assistant",
            content: [RemChatMessageContent(type: "text", text: text, mimeType: nil, fileName: nil, content: nil)],
            timestamp: nil)
