...
struct ClientVersionHeaderTests {
    ...
    @Test func backendRequestCallSitesUseSharedClientVersionHeaders() throws {
        ...
        let callSitePaths = [
            "Rem/Sources/Services/Auth/AuthenticatedHttpClient.swift",
            "Rem/Sources/Services/Auth/RemAuthService.swift",
            "RemMac/Sources/Gateway/MacAuthenticatedHttpClient.swift",
            "RemMac/Sources/Gateway/MacGatewaySessionManager.swift",
