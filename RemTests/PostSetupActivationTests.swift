...
struct PostSetupActivationTests {
    @Test func postSetupActivationIsScopedToNewGatewaySetup() throws {
        ...
        let contentView = try read("Rem/ContentView.swift", from: projectRoot)
        ...
        let onboardingFlow = try read("Rem/Sources/Onboarding/OnboardingFlow.swift", from: projectRoot)
    ...
    @Test func activationCopyStaysCloudSafeAndActionable() throws {
        ...
        let activationView = try read("Rem/Sources/Onboarding/PostSetupActivationView.swift", from: projectRoot)
    ...
    @Test func activationFixtureAndDocsAreWired() throws {
        ...
        let app = try read("Rem/RemApp.swift", from: projectRoot)
        ...
        let consentView = try read("Rem/Sources/Onboarding/AIDataSharingConsentView.swift", from: projectRoot)
        #expect(consentView.contains(".remPrimaryActionButton()"))

        let contentView = try read("Rem/ContentView.swift", from: projectRoot)
        #expect(contentView.contains("FirstUseHintFixtureButton"))

        let readme = try read("Rem/Sources/Onboarding/README.md", from: projectRoot)
