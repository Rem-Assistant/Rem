...
struct ChatLifecycleDisplayTests {
    ...
    @Test func combinedReasoningAndFinalTextBothRemainVisible() {
        let content = RemChatMessageContent(
            type: "text",
    ...
    @Test func completedRunDurationRequiresTerminalAssistantContentAndTimestamp() {
        ...
        let missingTimestamp = RemChatMessage(
            role: "assistant",
            content: [RemChatMessageContent(
        ...
        let preToolSentence = RemChatMessage(
            role: "assistant",
            content: [
                RemChatMessageContent(
    ...
    @Test func unknownRichResultsStayVisibleWhileBrowserDiagnosticsFold() {
        ...
        let mixedMessage = RemChatMessage(
            role: "toolResult",
            content: [
                RemChatMessageContent(
                    type: "toolResult",
    ...
    @Test func functionRoleHistoryDoesNotOwnLiveRunLifecycle() {
        let functionResult = RemChatMessage(
            role: "function",
            content: [RemChatMessageContent(
    ...
    @Test func browserCardTurnIncludesSplitCallAndResultButNotEarlierTurns() {
        let earlierCall = RemChatMessage(role: "assistant", content: [], timestamp: nil)
        let user = RemChatMessage(role: "user", content: [], timestamp: nil)
        let browserCall = RemChatMessage(role: "assistant", content: [], timestamp: nil)
        let browserResult = RemChatMessage(role: "toolResult", content: [], timestamp: nil)
        let answer = RemChatMessage(role: "assistant", content: [], timestamp: nil)
        let nextUser = RemChatMessage(role: "user", content: [], timestamp: nil)
    ...
    @Test func liveBrowserCardWaitsForExactToolCallIdentityBeforeSuppressingHistory() {
        let earlierUser = RemChatMessage(role: "user", content: [], timestamp: nil)
        let earlierBrowserCall = RemChatMessage(
            role: "assistant",
            content: [RemChatMessageContent(
                type: "toolCall", text: nil, mimeType: nil, fileName: nil, content: nil,
        ...
        let currentBrowserCall = RemChatMessage(
            role: "assistant",
            content: [RemChatMessageContent(
                type: "toolCall", text: nil, mimeType: nil, fileName: nil, content: nil,
        ...
        let currentResult = RemChatMessage(role: "toolResult", content: [], timestamp: nil)
