...
struct SharedSuggestionSectionContractTests {
    ...
    @Test func noSurfaceConstructsSuggestionRowsOutsideTheSharedSection() throws {
        let callSites = [
            ...
            "Rem/Sources/Screens/AgendaView.swift",
            "RemMac/Sources/UI/MacChatWindow.swift",
            "RemMac/Sources/UI/MacAgendaView.swift",
        ]
    ...
    @Test func inlineSetIsOrderedAgainstTheBrief() throws {
        ...
        let agenda = try source("Rem/Sources/Screens/AgendaView.swift")
