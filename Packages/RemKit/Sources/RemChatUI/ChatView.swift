...
@MainActor
public struct RemGatewayChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private func mergeToolResults(in messages: [RemChatMessage]) -> [RemChatMessage] {
    ...
    private func isToolResultMessage(_ message: RemChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func shouldDisplayMessage(_ message: RemChatMessage) -> Bool {
    ...
    private func primaryText(in message: RemChatMessage) -> String {
    ...
    private func hasInlineAttachments(in message: RemChatMessage) -> Bool {
    ...
    private func toolCalls(in message: RemChatMessage) -> [RemChatMessageContent] {
    ...
    private func inlineToolResults(in message: RemChatMessage) -> [RemChatMessageContent] {
        message.content.filter { content in
            let kind = (content.type ?? "").lowercased()
    ...
    private func toolCallIds(in message: RemChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: RemChatMessage) -> String {
