...
public struct RemChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct RemChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct RemChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [RemChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [RemChatThinkingLevelOption]? = nil,
...
public struct RemChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct RemChatSessionsListResponse: Codable, Sendable {
    ...
    public let defaults: RemChatSessionsDefaults?
    public let sessions: [RemChatSessionEntry]
