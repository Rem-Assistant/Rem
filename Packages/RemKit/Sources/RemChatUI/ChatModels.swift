...
public typealias RemGatewayPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias RemGatewayPlatformImage = UIImage
#endif

public struct RemChatUsageCost: Codable, Hashable, Sendable {
...
public struct RemChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: RemChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(RemChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct RemChatMessageContent: Codable, Hashable, Sendable {
...
public struct RemChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [RemChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: RemChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [RemChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: RemChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(RemChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([RemChatMessageContent].self, forKey: .content) {
...
public struct RemChatHistoryPayload: Codable, Sendable {
...
public struct RemSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct RemSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [RemSessionPreviewItem]
}

public struct RemSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [RemSessionPreviewEntry]

    public init(ts: Int, previews: [RemSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct RemChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct RemChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct RemSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let message: RemChatMessage?
...
public struct RemAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct RemChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct RemGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct RemPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: RemGatewayPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: RemGatewayPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct RemChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
