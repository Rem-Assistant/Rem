...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: RemProtocol.AnyCodable]?
    {
        ...
        return [
            "id": RemProtocol.AnyCodable(identity.deviceId),
            "publicKey": RemProtocol.AnyCodable(publicKey),
            "signature": RemProtocol.AnyCodable(signature),
            "signedAt": RemProtocol.AnyCodable(signedAtMs),
            "nonce": RemProtocol.AnyCodable(nonce),
        ]
    }
}
