...
public enum RemCanvasA2UICommand: String, Codable, Sendable {
...
public struct RemCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct RemCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
