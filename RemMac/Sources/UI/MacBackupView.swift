...
struct MacBackupView: View {
    ...
    var body: some View {
        Form {
            Section {
                VStack(alignment: .leading, spacing: DesignTokens.Spacing.md) {
                    HStack(alignment: .top, spacing: DesignTokens.Spacing.sm) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("Create a portable gateway archive before wiping, migrating, or rebuilding this Mac.")
                ...
                Text("Backups include gateway configuration and, when enabled below, workspace files.")
                    .font(DesignTokens.Typography.caption1)
                    .foregroundColor(DesignTokens.Color.labelSecondary)
            }
            ...
            Section {
                ...
                Text("tar -xzf <archive>.tar.gz -C $HOME")
                    .font(.system(.caption, design: .monospaced))
                    .padding(.vertical, 2)
                Text("The gateway does not ship a built-in restore command yet. Extracting the archive over your home directory is the documented restore path.")
                    .font(DesignTokens.Typography.caption1)
                    .foregroundColor(DesignTokens.Color.labelSecondary)
            } header: {
                Text("Restore")
    ...
    private func chooseOutputFolder() {
        ...
        panel.prompt = "Choose"
        panel.message = "Choose a folder for gateway backup archives."
