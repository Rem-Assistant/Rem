...
struct MacSessionsView: View {
    ...
    @State private var sessions: [RemChatSessionEntry] = []
    ...
    @ViewBuilder
    private func sessionRow(_ entry: RemChatSessionEntry) -> some View {
        HStack(spacing: 10) {
    ...
    private var filteredSessions: [RemChatSessionEntry] {
    ...
    private func dedupedSessions(_ sessions: [RemChatSessionEntry]) -> [RemChatSessionEntry] {
        var seen = Set<String>()
    ...
    private func reconcileAcceptedSessionMetadata(_ acceptedSessions: [RemChatSessionEntry]) {
    ...
    private func loadMoreIfNeeded(after entry: RemChatSessionEntry) {
    ...
    private func sessionDisplayName(_ entry: RemChatSessionEntry) -> String {
    ...
    private func sessionTimestamp(_ entry: RemChatSessionEntry) -> Date {
    ...
    private func relativeTimestamp(for entry: RemChatSessionEntry) -> String {
    ...
    private func deleteSession(_ entry: RemChatSessionEntry) {
        Task {
