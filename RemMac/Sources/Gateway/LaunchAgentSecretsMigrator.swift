...
/// pre-#275 Rem Mac builds. The plist held provider API keys and the
...
enum LaunchAgentSecretsMigrator {
    ...
    /// service used elsewhere in the Mac app (e.g. `RemMacApp`'s
    ...
    static func runIfNeeded(
        ...
        if let token = extracted.gatewayAuthToken {
