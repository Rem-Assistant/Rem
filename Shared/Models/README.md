...
| `TaskCollaboration.swift` | Shared task-comment/runtime contracts. Runtime decoding is tolerant for rolling deploys; `rem_runtime` attributes work executed by the shared Rem-owned runtime while legacy gateway evidence remains readable. |
