...
final class RemGatewaySessionManager {
    ...
    private func startKeepalive() {
        ...
        // fires RemKit's disconnect callback). Two strikes at a 20s interval
    ...
    func recheckConfigured() {
        ...
        print("[Rem] recheckConfigured() → isConfigured=\(configured) url=\(RemCredentialStore.gatewayURL ?? "nil")")
    ...
    /// Creates an RemChatTransport for use with RemGatewayChatView.
    ...
    func makeChatTransport(
        ...
        return IOSGatewayChatTransport(
            ...
            taskContinuationProvider: taskContinuationProvider,
