...
struct ChatHistoryView: View {
    ...
    private var allSessions: [RemChatSessionEntry] {
    ...
    @ViewBuilder
    private func sessionRow(_ session: RemChatSessionEntry) -> some View {
    ...
    private func sessionTimestamp(_ session: RemChatSessionEntry) -> Date {
    ...
    private func relativeTimestamp(for session: RemChatSessionEntry) -> String {
    ...
    private func sessionDisplayName(_ session: RemChatSessionEntry) -> String {
    ...
    private func sessionSubtitle(for session: RemChatSessionEntry) -> String? {
    ...
    private func deleteSession(_ session: RemChatSessionEntry) {
        Task {
    ...
    private func loadMoreIfNeeded(after session: RemChatSessionEntry) {
