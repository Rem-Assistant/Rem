...
- Device sign-in on **Production** (Staging may not accept “Continue with this device” yet)
- Google sign-in is optional and often blocked without an Android OAuth client
